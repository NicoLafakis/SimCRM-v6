...
module.exports = (client) => ({
  ...
  create: async (fromObjectType, fromObjectId, toObjectType, toObjectId, associationTypeId, category = ASSOCIATION_CATEGORIES.HUBSPOT_DEFINED) => {
    const url = `/crm/v4/objects/${fromObjectType}/${fromObjectId}/associations/${toObjectType}/${toObjectId}`
    const body = [
      {
  ...
  createDefault: async (fromObjectType, fromObjectId, toObjectType, toObjectId) => {
    const url = `/crm/v4/objects/${fromObjectType}/${fromObjectId}/associations/default/${toObjectType}/${toObjectId}`
  ...
  batchCreate: async (fromObjectType, toObjectType, associations) => {
    const url = `/crm/v4/associations/${fromObjectType}/${toObjectType}/batch/create`
  ...
  get: async (fromObjectType, fromObjectId, toObjectType) => {
    const url = `/crm/v4/objects/${fromObjectType}/${fromObjectId}/associations/${toObjectType}`
  ...
  batchGet: async (fromObjectType, toObjectType, objectIds) => {
    const url = `/crm/v4/associations/${fromObjectType}/${toObjectType}/batch/read`
  ...
  batchRemove: async (fromObjectType, toObjectType, pairs) => {
    const url = `/crm/v4/associations/${fromObjectType}/${toObjectType}/batch/archive`
